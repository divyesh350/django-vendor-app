...
from vendor.views import SendOTPView, VerifyOTPView, SignupView, GetProfileView, UploadDocumentView, GetDocumentsView, GetDocumentView, WalletView, WalletBalanceView, GenerateQuotationPDFView
